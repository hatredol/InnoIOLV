<!DOCTYPE HTML>
    ...
    <script>
      $(document).ready(function(){
        ...
        $("#clear-notification").click(function() {
          $("#notification").clear();
          $(".main > p").html("Notification cleared. Will be polled in 2 seconds")
          return false;
        });
      });
    ...
    <header>
      ...
      <div class="row-fluid text-center" style="border-bottom: 3px solid #3498db; padding:10px 0px;">
          ...
          <div class="span10">
            <h1 class="grande">Titulo de la Conferencia</h1>
          </div>
      </div>
      <section id="expo">
        <div class="container-fluid">
          <div class="row-fluid">
            <div class="span6">
              ...
              <p class="text-registro">Registrate para participar</p>
            ...
            <div class="span6" style="text-align:right">
              ...
              <h2 class="intro">  Tema de </h2>
              <h2 class="intro-after"> la conferencia</h2>
